...
public class SearchSettingsDialog extends DialogFragment implements Constants {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_0));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_1));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_2));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_3));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_4));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_5));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_6));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_7));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_8));
        workoutTypeSpinnerAdapter.add(getResources().getString(R.string.personal_priority_9));
        ...
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_0));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_1));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_2));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_3));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_4));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_5));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_6));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_7));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_8));
        fitnessGoalsSpinnerAdapter.add(getResources().getString(R.string.world_view_9));
