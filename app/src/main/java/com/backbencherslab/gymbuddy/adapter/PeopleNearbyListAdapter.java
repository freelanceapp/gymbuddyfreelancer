...
public class PeopleNearbyListAdapter extends BaseAdapter {
	...
	public PeopleNearbyListAdapter(Activity activity, List<Profile> searchResults) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            viewHolder.mDistance = (TextView) convertView.findViewById(R.id.timeAgo);
        ...
        viewHolder.mDistance.setTag(position);
		...
		if (u.getDistance() > 0.1) {

			viewHolder.mDistance.setText(Double.toString(u.getDistance()) + "km");

		} else {

			viewHolder.mDistance.setText(activity.getString(R.string.label_nearby));
		}
