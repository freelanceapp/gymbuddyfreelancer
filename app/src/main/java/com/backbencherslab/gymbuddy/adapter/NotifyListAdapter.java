...
import com.backbencherslab.gymbuddy.ProfileActivity;
...
import com.backbencherslab.gymbuddy.model.Notify;
...
public class NotifyListAdapter extends BaseAdapter implements Constants {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (notify.getType() == NOTIFY_TYPE_LIKE) {
            ...
            viewHolder.notifyTitle.setText(notify.getFromUserFullname() + " " + activity.getText(R.string.label_likes_profile));
