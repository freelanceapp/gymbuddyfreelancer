...
public class NotificationsSettingsFragment extends PreferenceFragment implements Constants {
    ...
    private CheckBoxPreference mAllowLikesGCM, mAllowFollowersGCM, mAllowMessagesGCM, mAllowGiftsGCM;

    private ProgressDialog pDialog;

    int mAllowLikes, mAllowFollowers, mAllowMessages, mAllowGifts;
